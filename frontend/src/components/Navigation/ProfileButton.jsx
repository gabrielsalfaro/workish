        ...
        {user ? (
          ...
          <div className="profile-menu-list-items">
            ...
            <hr className='menu-hr' />
             ...
             <li><NavLink to="/companies/search" onClick={closeMenu} className={'my-company-navlink'}>Search for Company</NavLink></li>
             <li><NavLink to="/companies/me" onClick={closeMenu} className={'my-company-navlink'}>View My Company</NavLink></li>
            <hr className='menu-hr' />
            <li>
